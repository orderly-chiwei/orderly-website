...
const imgWhyIconContainer11 = "/images/Omnichain-by-Default.avif";
const imgWhyIconContainer21 = "/images/you-own-the-economics.avif";
const imgFrame16188720501 = "/images/ship-fast.avif";
const imgWhyIconContainer41 = "/images/self-custody.avif";
const imgWhyIconContainer51 = "/images/battle-tested.avif";
  ...
  return (
    <div className="absolute contents left-[224px] top-[233.29px]" data-name="Why Icon Container">
      <div className="absolute h-[199px] left-[224px] top-[233.29px] w-[143.5px]" data-name="Why Icon Container 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhyIconContainer2} />
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute bg-[#3f0086] content-stretch flex flex-col gap-[20px] h-[483px] items-start left-0 overflow-clip p-[36px] rounded-[30px] top-0 w-[410px]" data-name="Container">
      ...
      <p className="font-['Atyp_BL:Display_-_Medium',sans-serif] font-[507] h-[141.289px] leading-[1.3] relative shrink-0 text-[20px] text-[rgba(255,255,255,0.8)] w-[344.875px] whitespace-pre-wrap" style={{ fontVariationSettings: "'ital' 0, 'opsz' 72", fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
  ...
  return (
    <div className="absolute contents left-[164px] top-[232.29px]" data-name="Why Icon Container">
      <div className="absolute left-[164px] size-[200px] top-[232.29px]" data-name="Why Icon Container-1 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhyIconContainer11} />
      </div>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute bg-[#6700ce] content-stretch flex flex-col gap-[20px] h-[483px] items-start left-[435px] overflow-clip p-[36px] rounded-[30px] top-0 w-[410px]" data-name="Container">
      <p className="font-['Atyp_BL:Semibold',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[32px] text-white" style={{ fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute contents left-[calc(50%+67.68px)] top-[calc(50%+88.94px)]" data-name="Why Icon Container">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[212px] left-[calc(50%+67.68px)] top-[calc(50%+88.94px)] w-[238.5px]" data-name="Why Icon Container-2 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhyIconContainer21} />
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="absolute bg-[#3f0086] content-stretch flex flex-col gap-[20px] h-[483px] items-start left-[870px] overflow-clip p-[36px] rounded-[30px] top-0 w-[410px]" data-name="Container">
...
function Container3() {
  return (
    <div className="absolute bg-[#6700ce] content-stretch flex flex-col gap-[20px] h-[483px] items-start left-[1305px] overflow-clip p-[36px] rounded-[30px] top-0 w-[410px]" data-name="Container">
      <p className="font-['Atyp_BL:Semibold',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[32px] text-white" style={{ fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
        Ship Fast
      </p>
  ...
  return (
    <div className="absolute contents left-[192px] top-[228.92px]" data-name="Why Icon Container">
      <div className="absolute h-[222px] left-[192px] top-[228.92px] w-[181.5px]" data-name="Why Icon Container-4 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhyIconContainer41} />
      </div>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="absolute bg-[#3f0086] content-stretch flex flex-col gap-[20px] h-[483px] items-start left-[1740px] overflow-clip p-[36px] rounded-[30px] top-0 w-[410px]" data-name="Container">
      <p className="font-['Atyp_BL:Semibold',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[32px] text-white" style={{ fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
        Self Custody
      </p>
      <p className="font-['Atyp_BL:Display_-_Medium',sans-serif] font-[507] h-[141.289px] leading-[1.3] relative shrink-0 text-[20px] text-[rgba(255,255,255,0.8)] w-[344.875px] whitespace-pre-wrap" style={{ fontVariationSettings: "'ital' 0, 'opsz' 72", fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
  ...
  return (
    <div className="absolute contents left-[170.12px] top-[252.66px]" data-name="Why Icon Container">
      <div className="absolute h-[189.5px] left-[170.12px] top-[252.66px] w-[187.5px]" data-name="Why Icon Container-5 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgWhyIconContainer51} />
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute bg-[#6700ce] content-stretch flex flex-col gap-[20px] h-[483px] items-start left-[2175px] overflow-clip p-[36px] rounded-[30px] top-0 w-[410px]" data-name="Container">
      <p className="font-['Atyp_BL:Semibold',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[32px] text-white" style={{ fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
        Battle-Tested
      </p>
      <p className="font-['Atyp_BL:Display_-_Medium',sans-serif] font-[507] h-[141.289px] leading-[1.3] relative shrink-0 text-[20px] text-[rgba(255,255,255,0.8)] w-[344.875px] whitespace-pre-wrap" style={{ fontVariationSettings: "'ital' 0, 'opsz' 72", fontFeatureSettings: "'ss03', 'ss02', 'ss05', 'ss06'" }}>
