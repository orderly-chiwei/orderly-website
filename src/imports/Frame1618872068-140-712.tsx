...
function Frame45() {
  return (
    <div className="bg-black relative rounded-[24px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
...
function Frame48() {
  return (
    <div className="bg-[#7800f0] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
...
function Component1() {
  return (
    <div className="bg-white col-1 content-stretch flex gap-[6px] items-center ml-0 mt-0 p-[12px] relative rounded-[63px] row-1" data-name>
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Footer Status">
      <div className="col-1 flex flex-col font-['Atyp_BL:Display_-_SemiBold',sans-serif] font-[612] h-[38px] justify-center ml-0 mt-0 relative row-1 text-[16px] text-white tracking-[0.16px] w-[82px]" style={{ fontVariationSettings: "'ital' 0, 'opsz' 72" }}>
        <p className="leading-[0.753]">$0.10</p>
      </div>
      <FooterStatus1 />
    </div>
  );
